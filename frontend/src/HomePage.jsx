          ...
          <div className="w-full flex justify-center items-center mb-6">
            <div className="text-white text-center w-full">
              <div className="text-5xl xs:text-6xl sm:text-7xl md:text-9xl lg:text-[12rem] font-bold leading-none opacity-90">
                <span className="inline-block animate-pulse font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-400 mb-2">
                  {year[0]}
                </span>
                <span className="inline-block animate-pulse delay-200 font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-400 mb-2">
                  {year[1]}
                </span>
                <span className="inline-block animate-pulse delay-400 font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-400 mb-2">
                  {year[2]}
                </span>
                <span className="inline-block animate-pulse delay-600 font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-400 mb-2">
                  {year[3]}
                </span>
              </div>
            </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-16 md:h-24">
            <div className="flex items-end justify-center h-full">
              {[8, 6, 10, 8, 12, 6, 8, 10].map((height, index) => (
                <div
                  key={index}
                  className={`w-4 md:w-8 h-${height} md:h-${
                    height * 2
                  } bg-gray-900/60 mx-0.5 md:mx-1`}
