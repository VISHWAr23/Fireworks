...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      {/* Main Content - Always column, always centered */}
      <main className="relative z-10 flex flex-col items-center justify-center flex-1 w-full px-2 sm:px-4 md:px-6 py-6 md:py-12">
        ...
        <div className="w-full max-w-lg text-white text-center md:text-left mb-6">
          ...
          <div className="w-full flex justify-center items-center mb-6">
            <div className="text-white text-center w-full">
              <div className="text-5xl xs:text-6xl sm:text-7xl md:text-9xl lg:text-[12rem] font-bold leading-none opacity-90 transform hover:scale-105 transition-transform duration-500">
        ...
        {/* CrackersCartTable - Always centered */}
          <div>
            <CrackersCartTable />
          </div>
      ...
      {/* City skyline silhouette - always below table */}
